(function () {
    ...
    callWithJQuery(function ($) {
        ...
        aggregatorTemplates = {
            ...
            mySum: function (formatter) {
                if (formatter == null) {
                    formatter = usFmt;
                }
                return function () {
                    var attr;
                    attr = 'Максимальный Балл';
                    var attr2;
                    attr2 = 'Кол-во Баллов';
                    return function (data, rowKey, colKey) {
                        return {
                            ...
                            result: 0,
                            push: function (record) {
                                if (!isNaN(parseFloat(record[attr])) && !isNaN(parseFloat(record[attr2]))) {
                                    this.sumResult += parseFloat(record[attr2]);
                                    return this.sumMax += parseFloat(record[attr]);
                                }
                            },
                            value: function () {
                                this.result = this.sumResult * 100 / this.sumMax;
                                return this.result;
                            },
                            format: formatter,
                            numInputs: attr != null ? 0 : 1
